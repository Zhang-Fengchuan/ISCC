function[beta,BIC,Hhou,dzengjiahe1hou,dzengjiahe2hou,dzengjiahe3hou]=SCCgai2fenpro(x,y,lon,lat,options,lamuda,beta_hat_SCC1,t,diedai,Hqian,dzengjiahe1,dzengjiahe2,dzengjiahe3,zhibiaocishu)
% Description:
...
[H,Hhou,dzengjiahe1hou,dzengjiahe2hou,dzengjiahe3hou]=SCC_spanning_treegai2fenpro(lon,lat,p,0.1,x,y,lamuda,beta_hat_SCC1,t,Hqian,dzengjiahe1,dzengjiahe2,dzengjiahe3,zhibiaocishu);
%%%%%%%%%%
%%%%%%%%%%
%%%%%%%%%%
...
%yuanbeta=[];%%%%%%%%%%%%%%%%%%%5
%for r=1:p%%%%%%%%%%%%%%%%%%%%%
   % yuanbeta=[yuanbeta;dbeta(:,r)./std(dbeta(:,r))];%%%%%%%%%%%%%%%%%%%%%
%end%%%%%%%%%%%%%%%%%55
%xinbianliang=exp(abs(H*yuanbeta));%%%%%%%%%%%%%%%%%%%5
%xinbianliang=1./xinbianliang;%%%%%%%%%%%%%%%%%%%%%55

%xinbianliang=(xinbianliang./sum(xinbianliang(1:end-p)));
%xiuzheng=xinbianliang;%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%55
%number=size(find(xiuzheng~=1));
%xiuzheng(find(xiuzheng~=1))=1-abs(1-xiuzheng(find(xiuzheng~=1)))/((n-1)*diedai);%%%%%%%%%%%%%%%%%%%%%%%%%5
%xiuzheng(find(xiuzheng==inf))=999999;
G=Xg/H;
...
elseif options.intercept_type==1
    ...
    %options.penalty_factor(1:n*p-1,1)=xiuzheng(1:end-1);%%%%%%%%%%%%%%%%%%%
